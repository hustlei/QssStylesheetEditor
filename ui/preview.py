...
class previewWidget(QTabWidget):
    def __init__(self):
        ...
        tab5 = QWidget(self)
        tab6 = QWidget(self)
        self.addTab(tab1, self.tr("常用组件"))
        self.addTab(tab2, self.tr("特别组件"))
        self.addTab(tab3, self.tr("绘图组件"))
        self.addTab(tab4, self.tr("布局组件"))
        self.addTab(tab5, self.tr("容器组件"))
        self.addTab(tab6, self.tr("高级组件"))
        self.setupTab1(tab1)
        self.setupTab2(tab2)
        self.setupTab3(tab3)
        self.setupTab4(tab4)
