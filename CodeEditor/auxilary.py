...
binfiletypes = {'xls', 'eml', 'jpg', 'png', 'gif', 'tif', 'bmp', 'bmp', 'bmp', 'dwg', 'psd', 'eml', 'doc', 'vsd', 'mdb',
                'ps', 'pdf', 'rmvb', 'flv', 'mp4', 'mp3', 'mpg', 'wmv', 'wav', 'avi', 'mid', 'zip', 'zip', 'zip', 'rar',
                'jar', 'exe', 'gz', 'class', 'chm', 'mxp', 'docx', 'wps'}
textfiletypes = {"html": "HTML", "htm": "HTML", "css": "CSS", "js": "JavaScript", "rtf": "Text", "ini": "Text",
                 "jsp": 'Text', "mf": "Text", "xml": "XML", "sql": "SQL", "java": "Java", "bat": "Batch",
                 "properties": "Text", "torrent": "XML"}
