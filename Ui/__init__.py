...
class QssWin(object):  
    ...
    def createActions(self):
        self.newAct=QAction(QIcon('img/bt_invite_normal.bmp'),"&New",self)
        self.newAct.setShortcut("Ctrl+N")
        self.newAct.setStatusTip("new")
        self.openAct=QAction(QIcon('img/bt_addto_normal.bmp'),"&Open",self)
        self.openAct.setShortcut("Ctrl+O")
        self.openAct.setStatusTip(self.tr("Open"))
        self.saveAct=QAction(QIcon('img/bt_filesend_normal.bmp'),"&Save",self)
        ...
        self.exitAct=QAction(QIcon('img/close.png'),"&Exit",self)
        self.exitAct.setShortcut("Ctrl+Q")
        self.exitAct.setStatusTip(self.tr("Close"))
        self.cutAct=QAction(QIcon('img/broadcast_send_cut_normal.bmp'),"&Cut",self)
        self.cutAct.setShortcut("Ctrl+X")
        self.cutAct.setStatusTip(self.tr("Cut"))
        self.copyAct=QAction(QIcon('img/broadcast_send_copy_normal.bmp'),"&Copy",self)
        self.copyAct.setShortcut("Ctrl+C")
        self.copyAct.setStatusTip(self.tr("Copy"))
        self.pasteAct=QAction(QIcon('img/broadcast_send_paste_normal.bmp'),"&Paste",self)
        ...
        self.renderAct=QAction("render",self)
        self.norenderAct=QAction("norender",self)
